<?php
	...
	$addlHeader .= "\n" . '<script language="JavaScript" src="includes/func.js"></script>';
 ...
 */
	...
	include_once('includes/header_flex.php');
		...
		foreach($myDocs as $doc) {
			...
			printTools($document_id, $pdfUrl);
                        ...
                        if ( isset($file_unitdate_display) )
                                ...
                                print "n.d.";
                        print " | ";*/
                        /*print "<p style='font-size:10px;margin-top:2px'>";
			//print "Number of pages: $pages; ";
                        //print "Folder number: $folder_num; ";
                        //print "Document ID: $document_id "; //<br />";
			print "<span id=\"citLink\"><strong><a href=\"javascript:openCitation('open')\" class=\"noUnderline\"><img src=\"http://www.columbia.edu/cu/lweb/digital/collections/cul/texts/images/bookcitation-sm.gif\" alt=\"citation\" height=\"8\" />&#160;View citation&#160;&#187;</a></strong></span>";
			print "</p>";*/
/*print '<div style="font-size:10px;float:right;background:#eee;margin-top:-10px;border:1px solid #369;width:200px;">';
getSimilarDocs($file_unittitle, $appUrl);
print "</div>\n";*/
