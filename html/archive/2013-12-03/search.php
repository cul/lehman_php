<?php
	$htmlTitle = "Lehman Special Correspondence Files::Search Results";
...
<div style="float:right;width:100px;"><a href="/lehman/">New search</a></div>
<div id="searchBox" style="padding:0;margin:0;">
<p><a href="javascript:toggle('searchForm', 'Refine search', 'Hide refine search')" class="toggle"><img id="IsearchForm" border="0" src="http://www.columbia.edu/cu/lweb/images/icons/left-off.gif"><span id="spanblurbsearchForm">Refine search</span></a></p>
<!-- <div class="expand" id="LsearchForm" style="padding:5px;margin:5px;display:none;"><!-- border:1px solid #ddd;background:#eee; -->
